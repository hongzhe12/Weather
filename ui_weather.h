...
public:
    ...
    void setupUi(QMainWindow *Weather)
    {
        ...
        Weather->resize(453, 445);
        centralwidget = new QWidget(Weather);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        textBrowser = new QTextBrowser(centralwidget);
        textBrowser->setObjectName(QString::fromUtf8("textBrowser"));
        textBrowser->setGeometry(QRect(40, 110, 371, 211));
        QFont font;
        ...
        label->setGeometry(QRect(46, 59, 81, 31));
        QFont font1;
        ...
        comboBox->setGeometry(QRect(298, 58, 111, 31));
        QFont font2;
        ...
        pushButtonGetWeather->setGeometry(QRect(45, 350, 80, 31));
        pushButtonGetWeather->setFont(font2);
        pushButtonClear = new QPushButton(centralwidget);
        pushButtonClear->setObjectName(QString::fromUtf8("pushButtonClear"));
        pushButtonClear->setGeometry(QRect(335, 350, 80, 31));
        pushButtonClear->setFont(font2);
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(299, 20, 111, 31));
        pushButton->setFont(font2);
        lineEdit = new QLineEdit(centralwidget);
        lineEdit->setObjectName(QString::fromUtf8("lineEdit"));
        lineEdit->setGeometry(QRect(40, 20, 211, 31));
